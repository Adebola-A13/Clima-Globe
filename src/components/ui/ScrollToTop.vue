...
<template>
  ...
  >
    <button
      v-if="showButton"
      @click="scrollToTop"
      class="fixed bottom-6 right-6 z-50 bg-indigo-950 hover:bg-indigo-950 text-white p-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 group focus:outline-none focus:ring-2 focus:ring-indigo-950 focus:ring-offset-2"
